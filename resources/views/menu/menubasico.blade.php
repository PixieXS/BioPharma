...
/* Centrar el main-content verticalmente */
.main-content {
  margin-left: 280px; /* Ajuste según el ancho del sidebar */
  padding: 40px;
  max-width: 800px;
  height: calc(100vh - 60px); /* Ajuste la altura al 100% de la pantalla menos la barra superior */
  overflow-y: auto;
