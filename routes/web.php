...
Route::get('/inventario/search', [MedicamentoController::class, 'search'])->name('medicamento.searchInventario');
Route::get('/inventario/reset', [MedicamentoController::class, 'reset'])->name('medicamento.resetInventario');
